    ...
    <div className="w-full">
      ...
      <div className="w-full flex relative h-full">
        ...
        <div className="absolute flex lg:flex-row flex-col max-[1023px]:py-20  w-full h-full">
          <div className="flex justify-center items-center lg:w-[50%] max-[1023px]:h-[20%] max-[768px]:h-[40%]">
            <div className="flex flex-col md:px-20 md:pb-0 pb-10 px-10">
          ...
          <div className="flex flex-col lg:w-[50%] justify-center items-center  max-[1023px]:h-[80%] max-[768px]:h-[60%]">
